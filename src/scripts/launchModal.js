...
function renderSurveyModal() {
    ...
    const question_section = "<div style='margin: 0px 2rem;'><h2> Do they share the same opinion? </h2> <button style='background-color: #35CD96;' class='my-button'> Yes </button><button style='background-color: #FF4975' class='my-button'> No </button></div>"
    const complete_modal = "<div style='margin: 16px 16px;'><h1 style='margin: 2rem 2rem;'> Here are two articles you've recently read: </h1>" + combine_article + question_section + "</div>"
