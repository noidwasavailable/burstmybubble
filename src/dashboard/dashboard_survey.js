...
//----------------Main process----------------------
window.localStorage.setItem("prev_site", "https://www.vox.com/recode/21546119/trump-conspiracy-theories-election-2020-coronavirus-voting-vote-by-mail")
...
function update_survey(articles) {
    // Change the titles
    document.getElementById("article1-title").innerHTML = articles.article1.data.title
    document.getElementById("article2-title").innerHTML = articles.article2.data.title
    // Change the categories
    document.getElementById("article1-cat").innerHTML = articles.article1.data.category.name
    document.getElementById("article2-cat").innerHTML = articles.article2.data.category.name
    ...
    document.getElementById("article1-sentiment").innerHTML = art1_sentiment.sentiment
    document.getElementById("article2-sentiment").innerHTML = art2_sentiment.sentiment
    document.getElementById("article1-sentiment").classList.add(art1_sentiment.css_class)
    document.getElementById("article2-sentiment").classList.add(art2_sentiment.css_class)
